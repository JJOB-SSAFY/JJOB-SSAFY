...
CREATE TABLE `career` (
  ...
  `career_period` varchar(255) DEFAULT NULL,
  `company_name` varchar(255) DEFAULT NULL,
  `resume_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`career_id`),
  KEY `FKrfa4rx0u68pso7sls4vprhaw2` (`resume_id`),
  CONSTRAINT `FKrfa4rx0u68pso7sls4vprhaw2` FOREIGN KEY (`resume_id`) REFERENCES `resume` (`resume_id`)
...
INSERT INTO `career` VALUES (2,'sw개발','1년','싸피',8),(3,'비서','2년','Google',9);
