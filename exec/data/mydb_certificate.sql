...
CREATE TABLE `certificate` (
  ...
  `certificate_institution` varchar(255) DEFAULT NULL,
  `certificate_name` varchar(255) DEFAULT NULL,
  `resume_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`certificate_id`),
  KEY `FKi4oy75n04281os1vrl5k2nmlu` (`resume_id`),
  CONSTRAINT `FKi4oy75n04281os1vrl5k2nmlu` FOREIGN KEY (`resume_id`) REFERENCES `resume` (`resume_id`)
...
INSERT INTO `certificate` VALUES (2,'23-05','','정보처리기사',8);
